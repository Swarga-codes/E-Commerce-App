            ...
            <div>
              <dl className=" space-y-1 px-2 py-4">
                <div className="flex items-center justify-between">
                  ...
                  <dd className="text-sm font-medium text-gray-900">${cart?.reduce((acc,curr)=>acc+curr.discountedPrice,0).toFixed(2)}</dd>
                </div>
                ...
                <div className="flex items-center justify-between border-y border-dashed py-4 ">
                  ...
                  <dd className="text-base font-medium text-gray-900">${cart.reduce((acc,curr)=>acc+curr.discountedPrice,0)}</dd>
                </div>
              </dl>
