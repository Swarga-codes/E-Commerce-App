...
function SellerAnalytics() {
    ...
    const[noOfOrdersCompleted,setNoOfOrdersCompleted]=useState("Hang on, loading...")
    ...
    async function getSellerOrders(){
        ...
        setNoOfOrdersCompleted(data.filter(order=>order.isComplete===true)?.length)
      }
    useEffect(()=>{
fetchMyProducts()
getSellerOrders()
  ...
  return (
    ...
    <AnalyticsCard heading={"Number of Products"} count={noOfProducts} animationData={Products}/>
    <AnalyticsCard heading={"Orders Received"} count={noOfOrders} animationData={Orders}/>
    <AnalyticsCard heading={"Orders Delivered"} count={noOfOrdersCompleted} animationData={OrdersComplete}/>
    </div>
    </div>
    </div>
  )
