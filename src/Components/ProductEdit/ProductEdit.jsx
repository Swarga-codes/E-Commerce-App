...
export default function ProductEdit({isOpen,closeModal,details}) {
  ...
  const [discountedPrice,setDiscountedPrice]=useState(details?.discountedPrice)
  ...
  <h2 className="text-sm font-semibold tracking-widest text-gray-500">#{details?.category}</h2>
            ...
            <label
            class="float-left mb-2 text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
            for="title"
          >
            Title
          </label>
          ...
          >
            ...
            <p className="leading-relaxed text-left mt-4" style={{'overflowWrap':'anywhere'}}>
            <b>Number of Stocks: <input type="number" value={quantity} onChange={(e)=>setQuantity(e.target.value)}/></b>
          </p>
        
            <div className="text-justify mt-3">
              <p className="title-font text-xl font-bold text-gray-900">Price: $<input type="number" value={price} onChange={(e)=>setPrice(e.target.value)}></input></p>
              <p className="title-font text-xl font-bold text-gray-900">Discounted Price: $<input type="number" value={discountedPrice} onChange={(e)=>setDiscountedPrice(e.target.value)} className="w-[10rem]"></input></p>
              </div>
             {!loader?
                 <button
              type="button"
