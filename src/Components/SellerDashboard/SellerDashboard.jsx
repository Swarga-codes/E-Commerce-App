...
function SellerDashboard() {
  ...
  async function completeOrder(orderID, productID) {
    const response = await fetch(
      `${import.meta.env.VITE_SERVER_API}api/sellers/completeorders/${orderID}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
            ...
            <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-700">
                  Below is a list of items ordered by you that are delivered
                  already or yet to be delivered.
                </p>
              </div>
              <div>
                {/* <button
