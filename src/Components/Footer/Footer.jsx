          ...
          <div className="w-auto p-8">
            <a href="#">
              <div className="inline-flex items-center">
                ...
                <span className="ml-4 text-lg font-bold">MyShop.</span>
              </div>
            </a>
          </div>
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              Made with ❤️ by &nbsp;
              <Link
                to={"https://github.com/Swarga-codes"}
                target="_blank"
                rel="noopener noreferrer"
              >
                <p className="underline">Swarga Codes</p>
              </Link>
            </ul>
          </div>
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <a
                  href="https://www.facebook.com/swargaraj.dutta/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <div className="w-auto p-1.5">
                <a
                  href="https://twitter.com/RajSwarga"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
              ...
              <div className="w-auto p-1.5">
                <a
                  href="https://www.instagram.com/m4rkus.js/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
